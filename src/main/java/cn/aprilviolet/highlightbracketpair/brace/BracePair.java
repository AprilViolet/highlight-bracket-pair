...
public class BracePair {
    ...
    public BracePair(IElementType leftType, IElementType rightType, String leftText, String rightText,
                     int leftOffset, int rightOffset) {
        this.leftBrace = new Brace(leftType, leftText, leftOffset);
        this.rightBrace = new Brace(rightType, rightText, rightOffset);
    }

    public BracePair(IElementType leftType, IElementType rightType,
                     HighlighterIterator leftIterator, HighlighterIterator rightIterator
    ) {
